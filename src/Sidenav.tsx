...
import { Button, Collapse, Dialog, DialogActions, DialogContent, DialogContentText, DialogProps, DialogTitle, Stack,Accordion, AccordionSummary, AccordionDetails } from '@mui/material'; // para mostrar u ocultar las materias
